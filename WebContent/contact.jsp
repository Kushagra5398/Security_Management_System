		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="Contact" method="post">
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="Type first name">
					<input id="first-name" class="input100" type="text" name="fname" placeholder="First name" autocomplete=off>
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<input id="email" class="input100" type="text" name="email" placeholder="Eg. example@email.com" autocomplete=off>
					<span class="focus-input100"></span>
				</div>

				<label class="label-input100" for="phone">Enter phone number</label>
				<div class="wrap-input100 validate-input" data-validate="Valid Mobile No is Required: 9999888877">
					<input id="phone" class="input100" type="text" name="phone" placeholder="Eg. +1 800 000000" autocomplete=off>
					<span class="focus-input100"></span>
				</div>

				<label class="label-input100" for="message">Message *</label>
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					<textarea id="message" class="input100" name="message" placeholder="Write us a message" autocomplete=off onsubmit="return validate()"></textarea>
					<span class="focus-input100"></span>
				</div>
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('contact/images/back1.jpg');">
				<div class="flex-w size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt2">
							51, Udyog Vihar, Udyog Vihar Extension, Ecotech-II, Udyog Vihar, Greater Noida, Uttar Pradesh 201306, India
						</span>
					</div>
				</div>
